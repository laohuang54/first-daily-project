...
public class AdminController {
    ...
    public Result add(@ModelAttribute ShopDTO shopDTO){
        ...
        try {
            ...
            MultipartFile ImgFile = shopDTO.getImg();
            ...
            if (ImgFile != null && !ImgFile.isEmpty()) {
                ...
                String objectName = "shop-img/" + UUID.randomUUID() + extension;
                // 2.3 调用改造后的AliOssUtil：传递 MultipartFile 和 objectName（核心修改）
                ImgUrl = aliOssUtil.upload(ImgFile.getBytes(), objectName);
            ...
            return shopService.add(shopDTO, ImgUrl);
